...
const fetchStops: CachedFetcher<RouteSegment[]> = async (getStops, date) => {
...
const fetchEvents: CachedFetcher<Vehicles[]> = async (getEvents) => {
...
const combineDeparturesAndStops = (departures, stops, date): PlannedDeparture[] => {
